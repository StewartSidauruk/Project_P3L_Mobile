...
class _HomeKurirState extends State<HomeKurir> {
  ...
  // State untuk search, sort, dan filter
  ...
  void _filterAndSortBarang() {
    ...
    if (_searchController.text.isNotEmpty) {
      ...
      tempBarang = tempBarang.where((barang) => barang['nama_barang'].toString().toLowerCase().contains(query)).toList();
    }
    if (_selectedKategoriId != null) {
      tempBarang = tempBarang.where((barang) => barang['id_kategori'] == _selectedKategoriId).toList();
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(icon: Icon(Icons.store_mall_directory_outlined), label: 'Jelajah'),
  ...
  AppBar _buildAppBar() {
    if (_selectedIndex != 0) {
      return AppBar(
        title: Text(
          _selectedIndex == 1 ? 'Tugas Pengiriman' : 'Profil',
    ...
    return AppBar(
      ...
      actions: [
                ...
                content: _notifications.isEmpty
                    ...
                    : SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) => ListTile(leading: const Icon(Icons.notifications), title: Text(_notifications[index])),
                        ),
                      ),
        ...
        IconButton(
          ...
          tooltip: 'Top Seller',
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const TopSellerView())),
        ),
      ],
    );
  }
